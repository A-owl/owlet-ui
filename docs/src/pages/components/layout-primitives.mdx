...
```jsx
// import { Pane, Text } from '@owlet/ui'
...
```jsx
// import { Pane, Button, Text, Heading } from '@owlet/ui'
...
```jsx
// import { Pane, Button, TextInput } from '@owlet/ui'
...
```jsx
// import { majorScale, Button } from '@owlet/ui'
...
```jsx
// import { minorScale, Button } from '@owlet/ui'
